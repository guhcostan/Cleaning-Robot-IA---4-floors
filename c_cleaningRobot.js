...
function makeDiagram(selector) {
    ...
    diagram.yPosition = (floorNumber) => floorNumber <= 1 ? 100 : 325;

	console.log(diagram.yPosition);
    diagram.root = d3.select(selector);
    diagram.robot = diagram.root.append('g')
        .attr('class', 'robot')
        .style('transform', `translate(${diagram.xPosition(world.location)}px,${diagram.yPosition(world.location)}px)`);
